...
public class Hotel
{
  ...
  public Reservation requestRoom(String guestName)
  {
    for (int i = 0; i < rooms.length; i++) {
      if (rooms[i] == null)
      {
        Reservation res = new Reservation(guestName,i); //creates the new reservation if it is empty
        return res; //returns the new reservation
      } //get help on these two statements - most important
    }
